...
{
    public partial class AddInquiryHederAndDetailToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InquryHeader", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InquryHeader_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InquiryDetail_InquryHeader_InquiryHeaderId",
                        column: x => x.InquiryHeaderId,
                        principalTable: "InquryHeader",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InquryHeader_ApplicationUserId",
                table: "InquryHeader",
